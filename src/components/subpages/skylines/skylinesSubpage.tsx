...
export default function SkylinesSubpage () {
    ...
    return (
        ...
        <div className="sl-cover-outer" style={{ display: "flex", justifyContent: "center", marginTop: '40px' }}>
        <Card className="sl-cover">
          <Card.Img src={album.cover} />
        </Card>
      </div>
      <div className="sl-comp-outer" style={{ display: 'flex', justifyContent: 'center', marginTop: '40px', marginBottom: '40px'}}>

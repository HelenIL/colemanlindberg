...
const album = {
  ...
  tracks: [
    ...
    album: 'Skylines',
    url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/01FirstAvenue.mp3',
    id: 0,
    image: cover,
  ...
  },
    {
      ...
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/02LakeStreet.mp3',
      id: 1,
      image: cover,
      pic: cole,
    ...
    },
    {
      ...
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/04ColdAsSnow.mp3',
      id: 3,
      image: cover,
      pic: cole,
    ...
    },
    {
      ...
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/05GoodTimes.mp3',
      id: 4,
      image: cover,
      pic: cole,
    ...
    },
    {
      ...
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/06SpringCocaine.mp3',
      id: 5,
      image: cover,
      pic: cole,
    ...
    },
    {
      ...
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/07TheWeight.mp3',
      id: 6,
      image: cover,
      pic: cole,
    ...
    },
    {
      ...
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/08StoryOfUs.mp3',
      id: 7,
      image: cover,
      pic: cole,
    ...
    { name: "Skyline Heaven", 
      artist: "Coleman Lindberg",
      album: 'Skylines',
      url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/skylines/09SkylineHeaven.mp3', 
      id: 8, 
      image: cover, 
      pic: cole, 

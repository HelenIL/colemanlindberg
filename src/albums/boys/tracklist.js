...
const album = {
  ...
  { 
    ...
    album: 'Boys', 
    url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/boys/01fourinchesaway.mp3', 
    id: 0, image: cover, pic: cole, lyrics: lyricArray[0].lyrics},
  { name: "Happy Now", artist: "Coleman Lindberg", album: 'Boys', 
    url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/boys/02happynow.mp3', 
  ...
  { name: "Slow News Day", artist: "Coleman Lindberg", album: 'Boys', 
    url: 'https://rlhgqzuuag32i5so.public.blob.vercel-storage.com/boys/04slownewsday.mp3', 
